...
def process_todos_to_single_issue(*, client: GitHubClient, issues: list[Issue]):
    ...
    * [x] #2
    """
    FOOTER = "Generated by Github Action, please do not edit. If you want to extract TODO into sub-issue, " \
             "please include `file:line` somethere in the body text and add label `todo`."
